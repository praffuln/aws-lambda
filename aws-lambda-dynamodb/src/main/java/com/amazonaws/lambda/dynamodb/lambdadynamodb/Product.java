...
//			System.getenv("PRODUCTS_TABLE_NAME");
	...
	public List<Product> list() throws IOException {
		...
		for (Product p : results) {
			System.out.println("Products - list(): " + p.toString());
		}
		return results;
	}
	...
	public Product get(String id) throws IOException {
		...
		if (result.size() > 0) {
			...
			System.out.println("Products - get(): product - Not Found.");
		}
		return product;
	}

	public void save(Product product) throws IOException {
		System.out.println("Products - save(): " + product.toString());
	...
	public Boolean delete(String id) throws IOException {
		...
		product = get(id);
		if (product != null) {
			System.out.println("Products - delete(): " + product.toString());
			this.mapper.delete(product);
		} else {
			System.out.println("Products - delete(): product - does not exist.");
			return false;
		}
		return true;
	}
